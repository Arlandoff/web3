...
import { ERC20_CONTRACT_ADDRESS, ERC721_CONTRACT_ADDRESS, ERC1155_CONTRACT_ADDRESS, TIP_JAR_CONTRACT_ADDRESS, STAKING_CONTRACT_ADDRESS, PROFILE_STATUS_CONTRACT_ADDRESS } from "../constants/addresses";
    ...
    <main className={styles.main}>
      <div className={styles.container}>
        <div className={styles.header}>
          ...
          <p className={styles.description}>Select the smart contract to interact with.</p>
        </div>
